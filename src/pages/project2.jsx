                ...
                <div className="py-14 px-0 max-w-4xl m-auto ">
                    ...
                    <div className="w-full max-w-3xl m-auto">
                        ...
                        <div>
                            ...
                            <a className='py-4 px-12 mr-5 text-base bg-[#7843E9] text-white uppercase tracking-[1px] inline-block font-bold rounded-[5px] shadow-[0_5px_15px_rgba(0,0,0,0.15)] transition-transform duration-300' href="https://egzersiz-rehberi-uygulamasi.vercel.app/" target="_blank" rel="noopener noreferrer">
                                {translations.liveLink}
                            </a>
