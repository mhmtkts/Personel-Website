        ...
        <section className="relative max-h-[120rem]" style={backgroundStyle}>
            <div className="pt-40 pb-40 max-w-3xl w-11/12 m-auto">
                ...
                <div className="mt-14 text-center">
                    <button onClick={() => window.open('https://budget-tracker-phi-seven.vercel.app/', '_blank')} className="py-4 px-16 text-xl bg-[#7843E9] text-white uppercase tracking-[1px] inline-block font-bold rounded-[5px] shadow-[0_5px_15px_rgba(0,0,0,0.15)] transition-transform duration-300">
            ...
            <div className="max-w-6xl w-11/12 m-auto">
                <div className="py-14 px-0 max-w-4xl m-auto ">
                    <div className="w-full mb-10">
                        <img src="/src/assets/Group-3.png" alt="Project 1" className="" />
                    </div>
