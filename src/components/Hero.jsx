...
const Hero = () => {
  ...
  return (
    <div className="flex justify-between items-start mt-16 p-8">
      <div className="w-1/2 space-y-6">
        ...
        <div className="flex space-x-4">
          <button
            ...
            className={`bg-[#3138a0] dark:bg-[#e0e2fe] text-[white] dark:text-[black]  ${darkMode ? "border-transparent" : "border-[#3138a0]"} w-32 border-2 text-lg font-semibold  px-4 py-3 rounded-md`}
          >
            {translations.hireMe}
          </button>
          <button
      ...
      <div className="w-[42%] h-96 overflow-hidden rounded-xl shadow-lg">
        <img
